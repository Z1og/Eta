...
# GitHub Official Workflow Sources

Reviewed and pinned on 2026-07-14. Method adapters only; upstream repositories are not vendored.

| Source | Workflows | License | Reviewed commit |
|---|---|---|---|
